...
class SiteOrigin_Premium_Plugin_Animations {
	...
	function register_scripts(){
		wp_register_script(
			...
			plugin_dir_url( __FILE__ ) . 'js/animate' . ( defined( 'SITEORIGIN_PREMIUM_JS_SUFFIX' ) ? SITEORIGIN_PREMIUM_JS_SUFFIX : '' ) . '.js',
			array( 'jquery' ),
		...
		wp_register_style(
			...
			plugin_dir_url( __FILE__ ) . 'css/animate' . ( defined( 'SITEORIGIN_PREMIUM_JS_SUFFIX' ) ? SITEORIGIN_PREMIUM_JS_SUFFIX : '' ) . '.css',
			array( ),
			SITEORIGIN_PREMIUM_VERSION
		);
	}
