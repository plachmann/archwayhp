...
class SiteOrigin_Premium_Plugin_Cpt_Builder {
	...
	function enqueue_admin_scripts( $page ) {
		...
		wp_localize_script(
		    ...
		    array(
				'loc' => array(
					'confirm_edit_slug' => __( 'Warning! Editing the post type slug will cause problems with existing posts of this type!', 'siteorigin-premium' ),
				),
			)
		);
	}
	...
	function builder_supports( $supports, $post, $panels_data ){
		...
		if(
			...
			$page_builder_supports = empty( $post_type_settings['page_builder_supports'] ) ? array() : $post_type_settings[ 'page_builder_supports' ];
			...
			$supports = wp_parse_args( array_fill_keys( $page_builder_supports, true ), $supports );
	...
	function get_form(){
		return SiteOrigin_Premium::single()->get_form(
			...
			array(
				...
				'page_builder_supports' => array(
					'type' => 'checkboxes',
					'label' => __( 'Page Builder Supports', 'siteorigin-premium' ),
					'multiple' => true,
					'options' => array(
						'addRow' => __( 'Add Row', 'siteorigin-premium'),
						'editRow' => __( 'Edit Row', 'siteorigin-premium'),
						'deleteRow' => __( 'Delete Row', 'siteorigin-premium'),
						'moveRow' => __( 'Move Row', 'siteorigin-premium'),
						'addWidget' => __( 'Add Widget', 'siteorigin-premium'),
						'editWidget' => __( 'Edit Widget', 'siteorigin-premium'),
						'deleteWidget' => __( 'Delete Widget', 'siteorigin-premium'),
						'moveWidget' => __( 'Move Widget', 'siteorigin-premium'),
						'prebuilt' => __( 'Prebuilt Layouts', 'siteorigin-premium'),
						'history' => __( 'History', 'siteorigin-premium'),
						'liveEditor' => __( 'Live Editor', 'siteorigin-premium'),
					),
					'default' => array( 'editWidget', 'history', 'liveEditor' )
				),
				'slug' => array(
					'type' => 'text',
